...
import { ListarOficiaisUsecase } from '@/_application/pessoas/usecases/listar/listar-oficiais-usecase'

export async function listarOficiaisController(
  ...
  const listarOficiais = new ListarOficiaisUsecase(pessoasPmRepository)
