...
export class AtualizarAvaliacaoDocumentoSGAService {
  constructor() {}
  ...
  public async execute({
    ...
    try {
      ...
      const tempFilePath = path.join(os.tmpdir(), `${Date.now()}-avaliacao.pdf`)
      ...
      throw new AppError(
        'Ocorreu um erro ao tentar atualizar o documento no SGA',
      )
    }
  }
}
